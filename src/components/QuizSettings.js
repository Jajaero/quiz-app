...
const QuizSettings = ({ onSettingsSaved }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3000/api/quizsettings', settings)
            .then(response => {
                console.log(response.data);
                onSettingsSaved(); // Notify parent component that settings are saved
            })
            .catch(error => {
